...
define(["VMPL_BugReplay/js/lib/recorder-manager", "VMPL_BugReplay/js/lib/items-paginator"], function (_recorderManager, _itemsPaginator) {
  var Runner = /*#__PURE__*/function () {
    ...
    _proto.exposeDemoActions = function exposeDemoActions() {
      ...
      // @ts-ignore
      window.demo = {
        getSessionRecords: function () {
          var _getSessionRecords = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, session;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 2;
                  _iterator = _asyncIterator(_this.manager.paginator);
                case 4:
                  _context.next = 6;
          ...
          function getSessionRecords() {
            return _getSessionRecords.apply(this, arguments);
          }
        ...
        deleteAllSessions: function deleteAllSessions() {
          _this.manager.deleteSession().then(function () {
