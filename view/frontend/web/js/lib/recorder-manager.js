  ...
  var RecorderManager = /*#__PURE__*/function () {
    ...
    _proto.deleteSession = /*#__PURE__*/function () {
      var _deleteSession = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(at) {
        var _this = this;
        var sessions, _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, session;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", this.paginator.fetch(at).then(function (session) {
                return _this.sessionWorker.delete([session]);
              }).then(function () {
            ...
            case 2:
              ...
              _context.prev = 5;
              _iterator = _asyncIterator(this.paginator);
            case 7:
              _context.next = 9;
            ...
            case 31:
              return _context.abrupt("return", this.sessionWorker.delete(sessions.filter(function (it) {
                return it !== undefined;
              })));
            case 32:
            case "end":
        ...
        }, _callee, this, [[5, 17, 21, 31], [22,, 26, 30]]);
      }));
      function deleteSession(_x) {
